    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">情绪收纳与疗愈</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 情绪分析与心理疗愈</span>
...
// 清理回复末尾的特殊标记 [QINGXU_SCORES]...[/QINGXU_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[QINGXU_SCORES\][\s\S]*?\[\/QINGXU_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 情绪收纳与心理疗愈】\n\n${cleanContent.value}\n\n体验心理自愈引擎：https://ai.wuxian.xyz`;
